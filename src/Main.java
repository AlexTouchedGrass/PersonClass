...
public class Main {
    public static void main(String[] args) {
        ...
        int p1Health = InputHelper.getRangedInt(scan, "Enter Person 1's HP:",0,20);
        ...
        int p2Health = InputHelper.getRangedInt(scan, "Enter Person 2's HP:",0,20);
        int p2Direction = InputHelper.getRangedInt(scan, "Enter Person 2's Direction:",1,6);
        ...
        int p3Health = InputHelper.getRangedInt(scan, "Enter Person 3's HP:",0,20);
        ...
        Person p2 = new Person(p2FirstName, p2LastName, p2Age, p2Health, p2Direction, p2X, p2Y, p2Z);
