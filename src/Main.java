...
public class Main {
    public static void main(String[] args) {
        ...
        int p1Age = InputHelper.getRangedInt(scan, "Get Person 1's Age: [1-60]", 1, 60);
        ...
        int p2Age = InputHelper.getRangedInt(scan, "Get Person 2's Age: [1-60]", 1, 60);
        ...
        int p2X = InputHelper.getRangedInt(scan, "Enter Person 2's X Coordinate:",0,10);
        int p2Y = InputHelper.getRangedInt(scan, "Enter Person 2's Y Coordinate:",0,10);
        int p2Z = InputHelper.getRangedInt(scan, "Enter Person 2's Z Coordinate:",0,10);
        ...
        int p3Age = InputHelper.getRangedInt(scan, "Get Person 3's Age: [1-60]", 1, 60);
        ...
        int p3X = InputHelper.getRangedInt(scan, "Enter Person 3's X Coordinate:",0,10);
        int p3Y = InputHelper.getRangedInt(scan, "Enter Person 3's Y Coordinate:",0,10);
        int p3Z = InputHelper.getRangedInt(scan, "Enter Person 3's Z Coordinate:",0,10);
